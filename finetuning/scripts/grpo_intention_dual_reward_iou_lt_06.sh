...
export OUTPUT_PATH="work_dirs/intention_grpo_dual_reward_debug"
export EXP_NAME="intention_grpo_dual_reward"
...
export DUAL_REWARD_IOU_THRESHOLD="0.5"  # IoU threshold (not used with F1, kept for compatibility)
...
echo ""
echo "Training Datasets (IoU < 0.6 - Most Difficult):"
...
python3 -m verl.trainer.main \
    ...
    data.config_path="configs/sft_intention_datasets_grpo_dual_reward.py" \
...
echo "   - Pure IoU GRPO (intention_grpo_iou_lt_06)"
