...
CHECKPOINT="finetuning/work_dirs/ovigod_grpo_resume/global_step_500/actor/huggingface"
MAX_SAMPLES=100
...
python evaluate_ovigod_ap.py \
    ...
    --backend vllm \
    --output_file ${OUTPUT_DIR}/grpo_resume_500_baseline.json || echo "Warning: Baseline failed, continuing..."
...
#     --temperature 1.0 \
#     --backend vllm \
#     --output_file ${OUTPUT_DIR}/grpo_resume_500_n4_vote0.5.json
